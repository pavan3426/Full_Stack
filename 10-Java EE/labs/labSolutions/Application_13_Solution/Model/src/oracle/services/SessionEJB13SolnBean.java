...
@Stateless(name = "SessionEJB13Soln", mappedName = "SessionEJB13Soln_Solution")
@Remote
@Local
public class SessionEJB13SolnBean implements SessionEJB13Soln, SessionEJB13SolnLocal {
    @PersistenceContext(unitName="FOD")
    private EntityManager em;

    public SessionEJB13SolnBean() {
    }
