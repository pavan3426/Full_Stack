...
import oracle.services.SessionEJB08Soln;

public class SessionEJB08Client {
    public static void main(String [] args) {
        try {
            final Context context = getInitialContext();
            SessionEJB08Soln sessionEJB = (SessionEJB08Soln)context.lookup("SessionEJB08_Solution#oracle.services.SessionEJB08Soln");
