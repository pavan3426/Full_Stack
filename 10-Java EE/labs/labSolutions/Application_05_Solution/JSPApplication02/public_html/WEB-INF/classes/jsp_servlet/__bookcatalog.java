...
public final class __bookcatalog extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/BookCatalog.jsp", 1223029004000L ,"10.3.0.0","Europe/Prague")) return true;
        if (sci.isResourceStale("/Books.html", 1223029004000L ,"10.3.0.0","Europe/Prague")) return true;
        return false;
    }
