...
import oracle.services.SessionEJB12SolnLocal;
...
public class ProductBrowsingBean {
    ...
    public SessionEJB12SolnLocal getSessionBean() 
                                throws NamingException {
        InitialContext ic = new InitialContext();
        Object lookupObject =
               ic.lookup("java:comp/env/ejb/local/SessionEJB12Soln");
        return (SessionEJB12SolnLocal)lookupObject;
    }
    ...
    private void resetAddProductFields() { 
          this.getNpName().resetValue();
          this.getNpDescription().resetValue();
          this.getNpAdditionalInfo().resetValue();
          this.getNpListPrice().resetValue();
          this.getNpMinPrice().resetValue();
          this.getNpCostPrice().resetValue();
    }
