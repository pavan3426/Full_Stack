...
import oracle.services.SessionEJB12Soln;

public class SessionEJBClient3 {
    public static void main(String [] args) {
        try {
            final Context context = getInitialContext();
            SessionEJB12Soln sessionEJB = (SessionEJB12Soln)context.lookup("SessionEJB12Soln_Solution#oracle.services.SessionEJB12Soln");
...
//            }
//            for (Person person : (List<Person>)sessionEJB.queryPersonFindById( /* FIXME: Pass parameters here */ )) {
//                System.out.println( "id = " + person.getId() );
//                System.out.println( "firstName = " + person.getFirstName() );
//                System.out.println( "lastName = " + person.getLastName() );
//                System.out.println( "email = " + person.getEmail() );
//                System.out.println( "phoneNumber = " + person.getPhoneNumber() );
//            }
//            for (Person person : (List<Person>)sessionEJB.queryPersonFindByLastName( /* FIXME: Pass parameters here */ )) {
//                System.out.println( "id = " + person.getId() );
//                System.out.println( "firstName = " + person.getFirstName() );
//                System.out.println( "lastName = " + person.getLastName() );
//                System.out.println( "email = " + person.getEmail() );
...
//            }
//            for (Product product : (List<Product>)sessionEJB.queryProductFindById( /* FIXME: Pass parameters here */ )) {
//                System.out.println( "additionalInfo = " + product.getAdditionalInfo() );
//                System.out.println( "costPrice = " + product.getCostPrice() );
//                System.out.println( "description = " + product.getDescription() );
//                System.out.println( "externalUrl = " + product.getExternalUrl() );
...
//                System.out.println( "category = " + product.getCategory() );
//            }
//            for (Product product : (List<Product>)sessionEJB.queryProductFindByName( /* FIXME: Pass parameters here */ )) {
//                System.out.println( "additionalInfo = " + product.getAdditionalInfo() );
//                System.out.println( "costPrice = " + product.getCostPrice() );
//                System.out.println( "description = " + product.getDescription() );
//                System.out.println( "externalUrl = " + product.getExternalUrl() );
