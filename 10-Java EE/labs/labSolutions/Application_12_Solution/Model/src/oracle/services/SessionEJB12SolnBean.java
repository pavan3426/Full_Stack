...
@Stateless(name = "SessionEJB12Soln", mappedName = "SessionEJB12Soln_Solution")
@Remote
@Local
public class SessionEJB12SolnBean implements SessionEJB12Soln, SessionEJB12SolnLocal {
    @PersistenceContext(unitName="FOD")
    private EntityManager em;

    public SessionEJB12SolnBean() {
    }
