...
@Stateless(name = "SessionEJB11Soln", mappedName = "SessionEJB11Soln_Solution")
@Remote
@Local
public class SessionEJB11SolnBean implements SessionEJB11Soln, SessionEJB11SolnLocal {
    @PersistenceContext(unitName="FOD")
    private EntityManager em;

    public SessionEJB11SolnBean() {
    }
