...
import oracle.services.SessionEJB11Soln;

public class SessionEJBClient3 {
    public static void main(String [] args) {
        try {
            final Context context = getInitialContext();
            SessionEJB11Soln sessionEJB = (SessionEJB11Soln)context.lookup("SessionEJB11Soln_Solution#oracle.services.SessionEJB11Soln");
