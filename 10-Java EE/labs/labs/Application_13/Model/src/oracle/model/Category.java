...
@NamedQueries({
  ...
  @NamedQuery(name = "Category.findRoot", query="select o from Category o where o.parent is null"),
  @NamedQuery(name = "Category.findLeaf", query="select o from Category o where o.parent is not null")
})
