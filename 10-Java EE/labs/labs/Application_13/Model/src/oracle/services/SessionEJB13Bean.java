...
@Stateless(name = "SessionEJB13", mappedName = "Application13-SessionEJB13")
@Remote
@Local
public class SessionEJB13Bean implements SessionEJB13, SessionEJB13Local {
    @PersistenceContext(unitName="FOD")
    private EntityManager em;

    public SessionEJB13Bean() {
    }
