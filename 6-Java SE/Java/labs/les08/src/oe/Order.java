...
public class Order  {
    ...
    Object[] msgVals = { new Integer (id), Util.toDateString(orderDate),shipMode,
        Util.toMoney(getOrderTotal))};
        return MessageFormat.format( "Order: {0} Date: {1} Shipped: {2} (Total: {3} )",msgVals);
...
//            (shipMode != null ? " Shipped: " + shipMode : "");
    ...
    public static String toMoney(double amount){
        DecimalFormat df = new DecimalFormat("$99,999,00");
